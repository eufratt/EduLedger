...
export default function NotifikasiCivitasPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center">
      ...
      <main className="w-full max-w-md px-4 py-6 flex flex-col gap-6 pb-24">
        {/* Summary Card */}
        <Card className="rounded-2xl border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden bg-card">
        ...
        {/* Footer Action */}
        <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md bg-white border-t border-slate-100 p-4 pb-8 flex justify-center z-40">
            <button 
